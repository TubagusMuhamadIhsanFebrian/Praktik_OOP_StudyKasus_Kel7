        ...
        while (true) {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    break;
                case 2:
                    cariMenuById(scanner, daftarMenu);
                    break;
                case 3:
                    tampilkanPerKategori(scanner, daftarMenu);
                    break;
                case 4:
                    prosesTambahStok(scanner, daftarMenu);
                    break;
                case 5:
                    prosesKurangiStok(scanner, daftarMenu);
                    break;
                case 6:
                    tampilkanStokMenipis(daftarMenu);
                    break;
                case 7:
                    tampilkanStokHabis(daftarMenu);
                    break;
                default:
